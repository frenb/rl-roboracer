...
{
    public class JointPositions : Message
    {
        public const string RosMessageName = "niryo_moveit/JointPositions";
        ...
        public JointPositions(double joint_00, double joint_01, double joint_02, double joint_03, double joint_04, double joint_05)
        {
