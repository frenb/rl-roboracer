...
# Python Workspace
python -m grpc_tools.protoc -Iprotos --python_out=Frontend/public/workspaces/python/ --grpc_python_out=Frontend/public/workspaces/pole_cart_python/ virtual_endpoint/proto/ros_service.proto
